...
<main class="flex-1 p-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Create New Setting</h1>
    ...
    <div class="w-full bg-white shadow-xl rounded-lg overflow-hidden">
        <form method="POST" action="{{ route('admin.settings.store') }}" class="p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="key" name="key" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('key') border-red-500 @enderror"
                        value="{{ old('key') }}"
            ...
            <div>
                ...
                <textarea id="value_string" name="value" rows="4"
                    class="value-input w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 @error('value') border-red-500 @enderror">{{ old('value') }}</textarea>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="2"
                    ...
                    placeholder="Briefly explain what this setting is for.">{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="is_public" id="is_public" class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                        <option value="0" {{ old('is_public') == '0' ? 'selected' : '' }}>No (Default)</option>
                ...
                <div>
                    ...
                    <select name="is_encrypted" id="is_encrypted" class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                        <option value="0" {{ old('is_encrypted') == '0' ? 'selected' : '' }}>No (Default)</option>
                        <option value="1" {{ old('is_encrypted') == '1' ? 'selected' : '' }}>Yes</option>
                    </select>
