@if($settingsService->get('takepayments_enabled'))
    <div class="payment-method payment-option p-4 rounded-lg cursor-pointer flex items-center justify-between"
        data-method="{{ $payMethod->value }}" onclick="selectPayment('takepayment')"  >
        ...
        <div>
            ...
            <p class="text-sm text-gray-600">Secure payment via Takepayments.</p>
        </div>
        <div>
