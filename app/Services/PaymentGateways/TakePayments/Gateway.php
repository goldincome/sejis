...
/**
 * Class to communicate with TakePayments Gateway
 */
...
class Gateway {
	 ...
	 */
	static public $hostedUrl = 'https://gw1.tponlinepayments.com/hosted/'; //'https://gw1.tponlinepayments.com/paymentform/';
